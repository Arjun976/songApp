...
import DownloadButton from "./DownloadButton"; // Same folder

const SongCard = ({ song, onPlay, onAddToPlaylist, onFavorite }) => {
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-center justify-between text-xs text-gray-500">
          <span className="flex items-center gap-1">
            <FaPlay className="text-purple-400" /> {song.plays?.toLocaleString() || 0}
          </span>
